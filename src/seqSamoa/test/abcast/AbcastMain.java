...
public class AbcastMain implements Callback {
	...
	public static void main(String args[]) {
		...
		if (line.equals("y")) {
			...
			processes.clear();
			//pid = readPID("lsepc32", "2765", "0");
			pid = readPID("obiwankenobi-nb", "2765", "0");
			processes.addLast(pid);
			pid = readPID("obiwankenobi-nb", "2766", "0");
			//pid = readPID("laptop", "2766", "0");
			processes.addLast(pid);
			pid = readPID("obiwankenobi-nb", "2777", "0");
		...
		ApiSamoaAbcastStack stack = new ApiSamoaAbcastStack(myself, processes,
				new SamoaScheduler(manager), new SamoaFlowControl(100),
				new AbcastMain(), null, SimpleRepConfiguration.getConfiguration());
		try {
			stack.init();
