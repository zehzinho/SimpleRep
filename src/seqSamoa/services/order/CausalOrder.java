 ...
 */
public class CausalOrder extends Service<CausalOrderCallParameters, CausalOrderResponseParameters> {
    public CausalOrder(String name, ProtocolStack stack) throws AlreadyExistingServiceException {
        super(name, stack, true, true);
    }
}
