 ...
 */
public class FIFO extends Service<FIFOCallParameters, FIFOResponseParameters> {
    public FIFO(String name, ProtocolStack stack) throws AlreadyExistingServiceException {
