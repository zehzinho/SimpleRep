...
import groupcomm.common.monitoring.InteractiveMonitoringImpl;

/**
 * This class implement a Protocol that remove processes highly suspected form
 * the current view. This microprotocl ask before removing a process.
 * 
 ...
 * util/Services.java)
 */
public class ProtocolInteractiveMonitoring extends ProtocolModule implements Trigger {
    final static int MAX_PROCESSES = 7;

    // Service required
    private ManageView manageView;

    protected InteractiveMonitoringImpl handlers;
     ...
     */
    public ProtocolInteractiveMonitoring(String name, ProtocolStack stack,
            ProcessSuspicion processSuspicion, ManageView manageView) throws AlreadyExistingProtocolModuleException {

        super(name, stack);
        handlers = new InteractiveMonitoringImpl(this);
