...
import groupcomm.common.consensus.ConsensusMR;
...
/**
 * This class implement the Consensus protocol of Mostéfaoui-Raynal.
 * 
 ...
 */
public class ProtocolConsensusMR extends ProtocolModule implements Trigger {
    ...
    protected ConsensusMR handlers;
     ...
     */
    public ProtocolConsensusMR(String name, ProtocolStack stack,
            Consensus consensus, FD fd, RPT2PT rpt2pt) throws AlreadyExistingProtocolModuleException {

        super(name, stack);
        handlers = new ConsensusMR(this, stack.getFlowControl(), stack.getPID());
            ...
            public void evaluate(ConsensusCallParameters params,
                ...
                synchronized (this.parent) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("ProtocolConsensusMR: "
	...
	public void trigger(int type, GroupCommEventArgs l) {
        ...
        default:
            throw new RuntimeException("ProtocolConsensusMR: trigger: "
