...
*  Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA  02110-1301  USA
 */
// Transportable class for TTreeMap
...
public class TTreeMap implements TSortedMap {
    ...
    public Transportable firstKey() {
        return (Transportable) contents.firstKey();
    }
    ...
    {
        return ("TTreeMap{" + contents + "}");
    }
    //End: to remove

    public boolean equals(Object o){
        throw new InternalError("TTreeMap not implementing equals");
    }

    public int compareTo(Object o){
        throw new InternalError("TTreeMap not implementing compareTo");
    }

    public Object clone(){
        TTreeMap clone;
        try {
            clone = (TTreeMap) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new InternalError();
        }
        TreeMap clone_contents = (TreeMap) contents.clone(); 
   ...
   public  TTreeMap(uka.transport.UnmarshalStream _stream)
   ...
   protected TTreeMap(uka.transport.UnmarshalStream  _stream, int _size)
	 throws java.io.IOException, ClassNotFoundException
   {
	 ...
	 throws CloneNotSupportedException
   {
	 ...
	 ((TTreeMap) _copy).deepCloneReferences(_helper);
	 return _copy;
   }
